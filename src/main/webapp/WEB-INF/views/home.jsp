  ...
  <div>
    ...
    <div class="lent_option-wrap">
      <div class="lent_option_box">
        <div>
          <a href="#"><img src="${root }resources/image/1.png" /></a>
        </div>
        <div>세탁기</div>
      </div>
      <div class="lent_option_box">
        <div>
          <a href="#"><img src="${root }resources/image/2.png" /></a>
        </div>
        <div>정수기</div>
      </div>
      <div class="lent_option_box">
        <div>
          <a href="#"><img src="${root }resources/image/3.png" /></a>
        </div>
        <div>공기청정기</div>
      </div>
      <div class="lent_option_box">
        <div>
          <a href="#"><img src="${root }resources/image/4.png" /></a>
        </div>
        <div>식기세척기</div>
      </div>
      <div class="lent_option_box">
        <div>
          <a href="#"><img src="${root }resources/image/5.png" /></a>
        </div>
        <div>전기레인지</div>
      </div>
      <div class="lent_option_box">
